package org.zaidaplutik.Utility;
 ...
 * </table>
 * </p> */
public class WeirdGroupStrategy implements GroupStrategy, Disposable {
  ...
  public WeirdGroupStrategy (final Camera camera) {
    this(camera, new Comparator<Decal>() {
      @Override
      public int compare (Decal o1, Decal o2) {
        float r= o2.getVertices()[Decal.Y4] - o1.getVertices()[Decal.Y4];
        if(r==0) r = o1.getVertices()[Decal.Z4] - o2.getVertices()[Decal.Z4];
        return (int)(r==0?1:r);
...
//        return o2.getY() - o1.getY() < 0 ? -1 : 1;
  ...
  public WeirdGroupStrategy (Camera camera, Comparator<Decal> sorter) {
    this.camera = camera;
  ...
  public void setBuffer(boolean useBuffer) {
...
//    return GROUP_BLEND;
  ...
  public void beforeGroups () {
    if(useBuffer) Gdx.gl.glEnable(GL20.GL_DEPTH_TEST);
  ...
  public void afterGroups () {
    if(useBuffer) Gdx.gl.glDisable(GL20.GL_DEPTH_TEST);
  }
